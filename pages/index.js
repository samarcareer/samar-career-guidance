    ...
    <div style={{
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .book-container { perspective: 2500px; display: flex; justify-content: center; align-items: center; width: 100%; }
        .book { position: relative; width: 440px; height: 600px; transform-style: preserve-3d; transition: transform 0.8s cubic-bezier(0.645, 0.045, 0.355, 1); }
        ...
        .book-title { font-size: 2.2rem; font-weight: 900; color: #fff; line-height: 1.2; text-shadow: 0 4px 15px rgba(56,189,248,0.4); }
        .book-subtitle { color: var(--accent); font-weight: 700; margin-top: 10px; font-size: 1.1rem; }
        .avatar-circle { width: 110px; height: 110px; border-radius: 50%; border: 3px solid var(--accent); display: flex; justify-content: center; align-items: center; margin: 0 auto 20px; font-size: 4rem; color: var(--accent); background: rgba(30, 64, 175, 0.3); }
        
        .standard-page h2 { font-size: 1.6rem; color: #fff; margin-bottom: 20px; border-bottom: 2px solid var(--accent); padding-bottom: 8px; }
        .timeline-item { border-left: 2px solid var(--accent); padding-left: 15px; position: relative; margin-bottom: 20px; }
          ...
          <div className="book" style={{ transform: getBookTransform() }}>
            ...
            <div className={`page ${1 < currentLoc ? 'flipped' : ''}`} style={{ zIndex: getZIndex(1) }}>
              <div className="front cover-page" style={{ textAlign: 'center', justifyContent: 'center' }}>
                ...
                <p style={{ margin: '20px 0', color: '#cbd5e1', lineHeight: '1.6', fontSize: '0.95rem' }}>
